...
def main():
    ...
    # Fix mismatched argument name: use --export_xlsx flag value
    export_excel = args.export_xlsx
    ...
    for paper in metadata:
        ...
        if date_in_range(year_month, year_month_filter):
            # Subject filter optional if not provided
            if (subjects is None) or any(subject in paper_dict['categories'] for subject in subjects):
