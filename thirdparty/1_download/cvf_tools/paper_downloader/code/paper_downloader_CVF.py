...
if __name__ == '__main__':
    ...
    download_paper(
        year,
        conference=conference,
        save_dir=f'/Users/suny0a/Proj/CoTT/papers/{conference}',
        is_download_main_paper=True,
        is_download_supplement=False,  # Do not download supplement materials
        time_step_in_seconds=10,
        is_download_main_conference=True,
        is_download_workshops=True,
        downloader=None,  # Use Python requests instead of IDM
